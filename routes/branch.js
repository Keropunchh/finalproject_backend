...
router.get("/staff",[passportJWT.isLogin,checkRole.isLevel3],branchController.staff );

router.get("/:id",branchController.show );

router.get("/staff/:id",[passportJWT.isLogin,checkRole.isLevel3],branchController.showstaff );

router.put("/:id",[passportJWT.isLogin,checkRole.isLevel3],branchController.update);

router.put("/staff/:id",[passportJWT.isLogin,checkRole.isLevel3],branchController.updatestaff);

router.delete("/:id",[passportJWT.isLogin,checkRole.isLevel3],branchController.destroy);

router.delete("/staff/:id",[passportJWT.isLogin,checkRole.isLevel3],branchController.destroystaff);
